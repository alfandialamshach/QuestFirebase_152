...
import com.example.firebaseandroid.ui.viewmodel.DetailMhsViewModel
import com.example.firebaseandroid.ui.viewmodel.DetailUiState
...
fun DetailMhsView(
    ...
    Scaffold(
        ...
        BodyDetailMhs(
            ...
            retryAction = { viewModel.ambilMahasiswa() }
        )
    }
}
@Composable
